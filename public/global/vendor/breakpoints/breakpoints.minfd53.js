...
!(function (t, n) {
    if ("function" == typeof define && define.amd) define(["exports"], n);
        ...
        var e = { exports: {} };
        n(e.exports), (t.breakpointsEs = e.exports);
    }
})(this, function (t) {
    "use strict";
    function n(t, n) {
    ...
    var r = (function () {
                ...
                r(t, [
                    {
                        ...
                        value: function (t, n) {
                            var e =
                                ...
                                void 0 !== arguments[2] &&
                                arguments[2];
                            this.list.push({ fn: t, data: n, one: e }),
                                this.length++;
                        },
                    },
                    {
        ...
        c = {
            ...
            trigger: function (t) {
                ...
                (this.current = t),
                    this.callbacks.fire(t, function (e, i) {
                        a.isFunction(i.fn) &&
                            i.fn.call({ current: t, previous: n }, i.data);
                    });
            },
            one: function (t, n) {
            ...
            on: function (t, n) {
                var e =
                    ...
                    void 0 !== arguments[2] &&
                    arguments[2];
                void 0 === n && a.isFunction(t) && ((n = t), (t = void 0)),
                        ...
                        value: function (t, n, e) {
                            ...
                            return (
                                void 0 === e &&
                                    ...
                                    ((e = n), (n = void 0)),
                                a.isFunction(e)
                                    ? (void 0 !== this.callbacks[t] &&
                                          (this.callbacks[t].add(e, n, i),
                                          "enter" === t &&
                                              this.isMatched() &&
                                              this.callbacks[t].call(this)),
                                      this)
                                    : this
                            );
                        },
                        ...
                        value: function (t, n) {
                            ...
                            return (
                                void 0 === t
                                    ...
                                    : t in this.callbacks &&
                                      (n
                                          ? this.callbacks[t].remove(n)
                                          : this.callbacks[t].empty()),
                                this
                            );
                        },
                    },
            ...
            between: function (t, n) {
                var e =
                    arguments.length > 2 && void 0 !== arguments[2]
                        ...
                        : "px";
                return (
                    "(min-width: " + t + e + ") and (max-width: " + n + e + ")"
                );
            },
            get: function (t, n) {
                var e =
        ...
        h = (function (t) {
            function o(t) {
                ...
                var l = u;
                return (
                    (u.changeListener = function () {
                        l.isMatched() && c.trigger(l);
                    }),
                    u.isMatched() && (c.current = u),
    ...
    var g = (y = a.extend(y, {
        ...
        define: function (t) {
            ...
            this.defined && this.destroy(),
                t || (t = y.defaults),
                (this.options = a.extend(n, { unit: "px" }));
            for (var e in t)
                t.hasOwnProperty(e) &&
                    this.set(e, t[e].min, t[e].max, this.options.unit);
            this.defined = !0;
        },
        destroy: function () {
        ...
        off: function (t, n, e) {
            if ("change" === (t = t.trim())) return c.off(n);
            if (t.includes(" ")) {
